...
class EmbeddingModelManager:
    ...
    def _get_model_drivers(cls):
        ...
        if cls._model_drivers is None:
            from app.engineering.llm.vendors.huggingface_embedding_model import HuggingFaceEmbeddingModel
            from app.engineering.llm.vendors.openai_embedding_model import OpenAIEmbeddingModel
            from app.engineering.llm.vendors.ollama_embedding_model import OllamaEmbeddingModel
