...
from app.core.config import DEFAULT_LLM_TOP_K, DEFAULT_VECTOR_TOP_K, DEFAULT_VECTOR_SCORE_THRESHOLD
...
class ModelParam(BaseModel):
    ...
    top_k: Optional[int] = Field(default=DEFAULT_LLM_TOP_K, ge=1, le=100)
...
class RAGConfig(BaseModel):
    ...
    scoreThreshold: float = DEFAULT_VECTOR_SCORE_THRESHOLD
    selectedFolders: List[str] = Field(default_factory=list)
    topK: int = DEFAULT_VECTOR_TOP_K
    vectorDbPath: str = ""
