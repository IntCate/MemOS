...
class FileUtils:
    ...
    @staticmethod
    def search_files(query, search_type='vector', k=5, vector_service=None, data_infrastructure=None):
        """
        搜索文件内容
        ...
        参数:
            ...
            data_infrastructure: 数据基础设施服务实例，用于获取文档列表
        ...
        try:
            ...
            if search_type == 'vector' and vector_service:
                ...
                if vector_results['success']:
                    ...
                    return []
            elif data_infrastructure:
                documents = data_infrastructure.get_all_documents()
