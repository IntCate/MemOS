...
class ErrorHandler:
    ...
    @staticmethod
    def async_handle_errors(default_return: Any = None, log_error: bool = True, log_level: str = "error", re_raise: bool = False):
        """
        异步错误处理装饰器，统一处理异步函数异常
...
async_handle_errors = ErrorHandler.async_handle_errors
