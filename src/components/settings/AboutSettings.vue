<template>
  <div class="max-w-2xl mx-auto">
    <div class="text-center mb-8">
      ...
      <h3 class="font-semibold text-xl">MemOS</h3>
      <div class="text-sm text-neutral mt-1">版本 v1.0.0</div>
    </div>

    <Card class="p-6 mb-6">
      <h4 class="font-medium mb-3">关于应用</h4>
      <p class="text-sm text-gray-700">MemOS新生代全栈AI应用平台，满足你所想、符合你所需</p>
    </Card>
    ...
    <div class="space-y-3">
      ...
      <a
        href="https://github.com/Kwillited/MemOS"
        target="_blank"
    ...
    <div class="mt-10 text-center text-xs text-neutral">© 2025 MemOS. 保留所有权利.</div>
  </div>
</template>
